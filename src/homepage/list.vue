  ...
  <div class="listbody">
    <div class="leftlist">
      ...
      <div class="listmenu">
        <!-- 靠下的部分 -->
        <div class="menutop">
          <span @click="zonghe" :class="{bluebg:1==autopaixu}">综合排序
            <span v-show="daosanjian"></span>
          </span>
          <span @click="upprice" :class="{bluebg:2==autopaixu}">价格↑↑
            <span v-show="!daosanjian"></span>
          </span>
        </div>
        <div class="menuhead">
        ...
        <div class="menuinner" v-for="(listobj) in listobjsA.page" :key="listobj.id">
          ...
          <div class="innerpay">
            ...
            <div>
              <a href="javascript:void(0)" class="buynow" @click="buyNow(listobj.id)">立即购买</a>
